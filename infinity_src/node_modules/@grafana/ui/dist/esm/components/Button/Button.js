...
const Button = React__default.forwardRef(
  (_a, ref) => {
    ...
    const button = /* @__PURE__ */ React__default.createElement("button", __spreadProps(__spreadValues({ className: cx(styles.button, className), type }, otherProps), { ref }), icon && /* @__PURE__ */ React__default.createElement(Icon, { name: icon, size, className: styles.icon }), children && /* @__PURE__ */ React__default.createElement("span", { className: styles.content }, children));
    if (tooltip) {
...
const LinkButton = React__default.forwardRef(
  (_c, ref) => {
    ...
    const button = /* @__PURE__ */ React__default.createElement("a", __spreadProps(__spreadValues({ className: linkButtonStyles }, otherProps), { tabIndex: disabled ? -1 : 0, ref }), icon && /* @__PURE__ */ React__default.createElement(Icon, { name: icon, size, className: styles.icon }), children && /* @__PURE__ */ React__default.createElement("span", { className: styles.content }, children));
    if (tooltip) {
      return /* @__PURE__ */ React__default.createElement(Tooltip, { content: tooltip, placement: tooltipPlacement }, button);
    }
    return button;
...
export { Button, LinkButton, clearButtonStyles, clearLinkButtonStyles, getButtonStyles, getPropertiesForVariant };
