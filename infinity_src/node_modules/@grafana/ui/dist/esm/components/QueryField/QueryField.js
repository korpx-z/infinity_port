...
class UnThemedQueryField extends PureComponent {
  ...
  render() {
    ...
    return /* @__PURE__ */ React__default.createElement("div", { className: cx(wrapperClassName, styles.wrapper) }, /* @__PURE__ */ React__default.createElement("div", { className: "slate-query-field", "aria-label": selectors.components.QueryField.container }, /* @__PURE__ */ React__default.createElement(
      Editor,
      {
