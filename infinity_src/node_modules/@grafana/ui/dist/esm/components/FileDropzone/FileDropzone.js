...
function FileDropzone({ options, children, readAs, onLoad, fileListRenderer, onFileRemove }) {
  ...
  return /* @__PURE__ */ React__default.createElement("div", { className: styles.container }, /* @__PURE__ */ React__default.createElement("div", __spreadValues({ "data-testid": "dropzone" }, getRootProps({ className: styles.dropzone })), /* @__PURE__ */ React__default.createElement("input", __spreadValues({}, getInputProps())), children != null ? children : /* @__PURE__ */ React__default.createElement(FileDropzoneDefaultChildren, { primaryText: getPrimaryText(files, options) })), fileErrors.length > 0 && renderErrorMessages(fileErrors), /* @__PURE__ */ React__default.createElement("div", { className: styles.acceptContainer }, (options == null ? void 0 : options.accept) && /* @__PURE__ */ React__default.createElement("small", { className: cx(styles.small, styles.acceptMargin, styles.acceptedFiles) }, getAcceptedFileTypeText(options.accept)), (options == null ? void 0 : options.maxSize) && /* @__PURE__ */ React__default.createElement("small", { className: cx(styles.small, styles.acceptMargin) }, `Max file size: ${formattedValueToString(
    formattedSize
  )}`)), fileList);
}
...
function FileDropzoneDefaultChildren({
  ...
  return /* @__PURE__ */ React__default.createElement("div", { className: styles.iconWrapper }, /* @__PURE__ */ React__default.createElement(Icon, { name: "upload", size: "xxl" }), /* @__PURE__ */ React__default.createElement("h3", null, primaryText), /* @__PURE__ */ React__default.createElement("small", { className: styles.small }, secondaryText));
}
