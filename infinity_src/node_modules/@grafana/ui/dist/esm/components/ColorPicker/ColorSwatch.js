...
const ColorSwatch = React__default.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React__default.createElement("div", __spreadValues({ ref, className: styles.wrapper, "data-testid": selectors.components.ColorSwatch.name }, otherProps), hasLabel && /* @__PURE__ */ React__default.createElement("span", { className: styles.label }, label), /* @__PURE__ */ React__default.createElement("button", __spreadProps(__spreadValues({ className: styles.swatch }, focusProps), { "aria-label": colorLabel })));
  }
);
