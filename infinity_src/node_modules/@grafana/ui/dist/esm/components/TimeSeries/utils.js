...
import { FieldType, getDisplayProcessor, getFieldColorModeForField, getFieldSeriesColor, FieldColorModeId, formattedValueToString, getFieldDisplayName, DashboardCursorSync, DataHoverEvent, DataHoverClearEvent } from '@grafana/data';
import { GraphDrawStyle, VisibilityMode, AxisPlacement, ScaleOrientation, ScaleDirection, StackingMode, AxisColorMode, GraphGradientMode, GraphTransform, GraphTresholdsStyleMode } from '@grafana/schema';
import { buildScaleKey } from '../GraphNG/utils.js';
import { UPlotConfigBuilder } from '../uPlot/config/UPlotConfigBuilder.js';
import { getScaleGradientFn } from '../uPlot/config/gradientFills.js';
...
const preparePlotConfigBuilder = ({
  ...
  for (let i = 1; i < frame.fields.length; i++) {
    ...
    if (customConfig.axisPlacement !== AxisPlacement.Hidden) {
      ...
      if (axisColor) {
        axisColorOpts = {
          ...
          color: customConfig.axisColorMode === AxisColorMode.Series ? axisColor : void 0
        };
      }
      let incrs;
    ...
    if (customConfig.thresholdsStyle && config.thresholds) {
      const thresholdDisplay = (_v = customConfig.thresholdsStyle.mode) != null ? _v : GraphTresholdsStyleMode.Off;
