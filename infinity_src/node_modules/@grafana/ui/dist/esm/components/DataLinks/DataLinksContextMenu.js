...
const DataLinksContextMenu = ({ children, links, style }) => {
  ...
  const renderMenuGroupItems = () => {
    return itemsGroup.map((group, index) => /* @__PURE__ */ React__default.createElement(MenuGroup, { key: `${group.label}${index}`, label: group.label }, (group.items || []).map((item) => /* @__PURE__ */ React__default.createElement(
      MenuItem,
      {
        key: item.label,
        url: item.url,
