    ...
    if (colorMode.id === FieldColorModeId.Thresholds) {
      if (thresholds.mode === ThresholdsMode.Absolute) {
        const valueStops = thresholds.steps.map(
          (step) => [step.value, colorManipulator.alpha(theme.visualization.getColorByName(step.color), opacity)]
        );
...
export { GradientDirection, getDataRange, getGradientRange, getHueGradientFn, getOpacityGradientFn, getScaleGradientFn, scaleGradient };
