...
var evaluate = function (commands, options) {
    return new Promise(function (resolve) {
        var output = (options === null || options === void 0 ? void 0 : options.data) || null;
        var currentTime = new Date();
        var previousValue = { output: output, context: { currentTime: currentTime } };
        commands.forEach(function (currentCommand) { return __awaiter(void 0, void 0, void 0, function () {
